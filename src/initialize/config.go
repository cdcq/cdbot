...
func InitViper() error {
	...
	v.AddConfigPath("/etc/cdbot/")   // path to look for the config file in
	v.AddConfigPath("$HOME/.cdbot/") // call multiple times to add many search paths
	v.AddConfigPath("/opt/cdbot/")
